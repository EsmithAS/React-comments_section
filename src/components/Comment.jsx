                    ...
                    <div className="flex items-center space-x-5">
                        <button className="inline-flex items-center space-x-1 text-indigo-600 font-bold">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                <path html-fill-rule="evenodd" d="M7.707 3.293a1 1 0 010 1.414L5.414 7H11a7 7 0 017 7v2a1 1 0 11-2 0v-2a5 5 0 00-5-5H5.414l2.293 2.293a1 1 0 11-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" html-clip-rule="evenodd" />
                            </svg>
                            <span>Reply</span>
                        </button>
                        {
                            false && (
                                <>
                                    <button className="inline-flex items-center space-x-1 text-red-600 font-semibold">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                            <path html-fill-rule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" html-clip-rule="evenodd" />
                                        </svg>
                                        <span>Delete</span>
                                    </button>
                                    <button className="inline-flex items-center space-x-1 text-gray-600 font-semibold">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                            ...
                                            <path html-fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" html-clip-rule="evenodd" />
                                        </svg>
                                        <span>Edit</span>
                                    </button>
                                </>
