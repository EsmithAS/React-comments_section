const InputComment = () => {
    return (
        <div className="w-full bg-white space-x-5 px-5 py-7 rounded-xl shadow-lg flex items-start">
            ...
            <textarea className="flex-1 text-sm border-2 px-4 py-2 rounded-md h-20 resize-none text-gray-500 outline-none focus:border-indigo-500" placeholder="Add a comment..." />
            <button className="bg-indigo-600 hover:bg-indigo-700 px-5 py-2 rounded-md text-sm text-indigo-100 font-bold uppercase">Send</button>
        </div>
    )
}
